...
$taskRequired = @('native/build/e2e_out_v14/ime_mixed_tip_v14.dll','native/build/e2e_out_v14/e2e_tip_tests.exe',
  'native/build/e2e_out_v14/tip_com_smoke.exe',
  'native/build/e2e_out_v14/engine/ime_engine_host.exe','native/build/e2e_out_v14/engine/public_dictionary.tsv',
...
& 'native/build/e2e_out_v14/e2e_tip_tests.exe' --tsf-smoke
if ($LASTEXITCODE -ne 0) { throw 'TSF thread activation smoke failed.' }
& 'native/build/e2e_out_v14/e2e_tip_tests.exe' --richedit-smoke
