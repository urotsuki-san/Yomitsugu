...
if ($taskManifest.version -ne '0.2.7-preview' -or $taskManifest.architecture -ne 'x64') { throw 'Manifest version or architecture mismatch' }
...
$taskCritical = @('ime_mixed_tip_v11.dll','ime_dictionary_tool.exe','ime_settings.exe','ime_tray.exe','install_preview.ps1','uninstall_preview.ps1','THIRD_PARTY.md','LICENSE',
  'update_public_dictionary.ps1','licenses/public-dictionary-NOTICE',
