...
$taskSetup = Join-Path $taskRoot 'dist/installer/Yomitsugu-0.2.8-preview-x64-setup.exe'
$taskInstallDir = Join-Path $env:ProgramFiles 'Yomitsugu/0.2.8-preview'
$taskDll = Join-Path $taskInstallDir 'ime_mixed_tip_v12.dll'
