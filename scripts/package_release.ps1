...
Copy-Item -LiteralPath (Join-Path $taskRoot 'native/build/e2e_out_v14/ime_mixed_tip_v14.dll') -Destination $taskPackage
Copy-Item -LiteralPath (Join-Path $taskRoot 'native/build/e2e_out_v14/engine') -Destination $taskPackage -Recurse
...
$taskManifest = [ordered]@{
    version='0.2.10-preview'; architecture='x64'; public_release_ready=$false;
