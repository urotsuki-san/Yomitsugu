...
| [EDRDG EDICT2](https://www.edrdg.org/pub/Nihongo/edict2u.gz) | noun, common-word, loanword and computing entries in the derived public dictionary | CC BY-SA 4.0; attribution and ShareAlike apply to derived dictionary entries | `native/third_party/public-dictionary-NOTICE.txt` |
